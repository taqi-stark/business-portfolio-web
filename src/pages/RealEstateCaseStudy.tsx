...
import { RealEstateMockup } from "@/components/mockups/RealEstateMockup";
...
export const RealEstateCaseStudy = () => {
  const caseStudy = businessData.caseStudies.find((c) => c.slug === "real-estate") || businessData.caseStudies[0];

  const getWhatsAppInquiry = () => {
    return `https://wa.me/${businessData.profile.whatsappNumber}?text=${encodeURIComponent(
      "Hi Ali, I reviewed your Real Estate Website case study and I'd like to build a similar website for my property office."
    )}`;
  };
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-b border-slate-200 pb-8">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 text-xs font-semibold text-slate-500">
              <span className="flex items-center gap-1.5">
                <Building2 className="h-4 w-4 text-slate-400" /> Client: {caseStudy.clientType}
              </span>
              <span>·</span>
              <span className="flex items-center gap-1.5">
                <MapPin className="h-4 w-4 text-slate-400" /> Market: Local & Overseas Pakistani Buyers
              </span>
              <span>·</span>
              <span className="rounded bg-emerald-100 text-emerald-800 px-2 py-0.5 font-bold">
          ...
          <div className="my-10 grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <span className="text-xs text-slate-500 font-medium">Inquiry Volume</span>
              <p className="font-mono text-2xl font-bold text-emerald-600 mt-1">3x Increase</p>
              <span className="text-[11px] text-slate-500 mt-1 block">In qualified buyer calls & WhatsApp leads</span>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <span className="text-xs text-slate-500 font-medium">Overseas Trust</span>
              <p className="font-mono text-2xl font-bold text-blue-600 mt-1">High Credibility</p>
              <span className="text-[11px] text-slate-500 mt-1 block">UK, UAE, and Gulf clients review verified plots</span>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <span className="text-xs text-slate-500 font-medium">Time Saved Daily</span>
              <p className="font-mono text-2xl font-bold text-slate-900 mt-1">2+ Hours</p>
              <span className="text-[11px] text-slate-500 mt-1 block">Answering basic prices and map locations</span>
            </div>
          </div>
          ...
          <div className="my-12">
            <div className="flex items-center justify-between mb-3 px-1">
              ...
              <span className="text-xs text-slate-500 font-medium">Try clicking filter tabs & WhatsApp button</span>
            </div>
            <RealEstateMockup interactive={true} />
          </div>
          ...
          <div className="card-premium p-6 sm:p-8 my-12 bg-white">
            <h3 className="text-xl font-bold text-slate-900 mb-4">Key Features Built For This Project</h3>
          ...
          {/* Live Demo & WhatsApp CTA Card */}
          <div className="rounded-3xl bg-slate-900 text-white p-8 sm:p-10 text-center shadow-xl">
            <h3 className="text-2xl sm:text-3xl font-extrabold text-white">
              Want a Similar Property Website for Your Agency?
            </h3>
            <p className="mt-3 text-sm text-slate-300 max-w-xl mx-auto leading-relaxed">
              I can build and launch a custom property portal for your office within 7 to 10 days, complete with Google Maps, WhatsApp inquiry routing, and mobile optimization.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              ...
              >
                ...
                <span>Discuss This Website on WhatsApp</span>
              </a>
              ...
              {caseStudy.liveUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-xl border border-slate-700 bg-slate-800 hover:bg-slate-700 text-white px-6 py-3.5 text-xs sm:text-sm font-bold transition-colors"
                >
                  <ExternalLink className="h-4 w-4" />
                  <span>Open Live Demo in New Window</span>
                </a>
              )}
            </div>
          </div>
